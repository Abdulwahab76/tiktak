...
const Discover: NextPage = () => {
  ...
  const topicStyle = ' hover:bg-primary lg:border-gray-300 px-3 py-2  flex items-center gap-2 justify-center cursor-pointer text-black';

  return (
    <div className='lg:border-b-2 lg:border-gray-200 pb-3'>
